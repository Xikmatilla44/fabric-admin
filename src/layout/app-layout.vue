<template>
    <v-navigation-drawer
        ...
        <v-list>
            ...
            <v-list-tile @click="changeRoute('Pos', 2)">
                <v-list-tile-action>
                    <v-icon>dashboard</v-icon>
                </v-list-tile-action>
                <v-list-tile-title :class="[{'active': selectedIndex === 2}, 'item-title' ]" >Pos</v-list-tile-title>
            </v-list-tile>
            ...
            <v-list-tile @click="changeRoute('Mailbox', 4)">
                ...
                <v-list-tile-title :class="[{'active': selectedIndex === 4}, 'item-title' ]">Mailbox</v-list-tile-title>
            </v-list-tile>
            ...
            <v-list-group
                ...
                <v-list-tile @click="changeRoute('Social', 5)">
                    ...
                    <v-list-tile-title :class="[{'active': selectedIndex === 5}, 'item-title' ]">Social</v-list-tile-title>
                </v-list-tile>
                <v-list-tile @click="changeRoute('Chart', 6)">
                    <v-list-tile-action>
                        <v-icon>bar_chart</v-icon>
                    </v-list-tile-action>
                    <v-list-tile-title :class="[{'active': selectedIndex === 6}, 'item-title' ]">Charts</v-list-tile-title>
                </v-list-tile>
                <v-list-tile @click="changeRoute('Media', 7)">
                    <v-list-tile-action>
                        <v-icon>perm_media</v-icon>
                    </v-list-tile-action>
                    <v-list-tile-title :class="[{'active': selectedIndex === 7}, 'item-title' ]">Media</v-list-tile-title>
                </v-list-tile>
            </v-list-group>
            ...
            <v-list-group
                ...
                <v-list-tile @click="changeRoute('Snackbar', 8)">
                    ...
                    <v-list-tile-title :class="[{'active': selectedIndex === 8}, 'item-title' ]">Snackbar</v-list-tile-title>
                </v-list-tile>
            </v-list-group>
